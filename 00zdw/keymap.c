...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LGUI, KC_Z),MT(MOD_LALT, KC_X),MT(MOD_RALT, KC_C),KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       MT(MOD_RALT, KC_DOT),MT(MOD_RGUI, KC_SLASH),KC_RIGHT_CTRL,  
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_CIRC,        KC_AMPR,        KC_LPRN,        KC_RPRN,        KC_ASTR,                                        KC_PLUS,        KC_4,           KC_5,           KC_6,           KC_DOT,         KC_BSPC,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_DLR,         KC_LCBR,        KC_RCBR,        KC_PERC,                                        KC_ASTR,        KC_1,           KC_2,           KC_3,           KC_EQUAL,       KC_ENTER,       
